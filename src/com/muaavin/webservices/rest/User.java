...
public class User {
	...
	public User(String user_name, String user_Id, String profile_pic , String state) {
		User_Name = user_name;
		User_ID = user_Id;
	 ...
	 public static User initializeUser(String Name ,String user_id , String profile_pic, String State )
	 {
		 User user = new User();
		 user.User_Name   = Name;
